                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control {{ $errors->has('work_schedule') ? 'is-invalid' : '' }}" name="work_schedule">
                                        <option  value="" selected disabled>Work Schedule</option>
                                        <option {{old('work_schedule')=="full_time"?"selected":""}} value="full_time">Full Time</option>
                                        <option {{old('work_schedule')=="part_time"?"selected":""}} value="part_time">Part Time</option>
                                        <option {{old('work_schedule')=="remote"?"selected":""}} value="remote">Remote</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control {{ $errors->has('experience') ? 'is-invalid' : '' }}" name="experience">
                                        ...
                                        <option {{old('experience')=="without_experience"?"selected":""}} value="without_experience">{{\App\Models\Advertisement::WITHOUT_EXPERIENCE}}</option>
                                        <option {{old('experience')=="less_than_one_year"?"selected":""}} value="less_than_one_year">{{\App\Models\Advertisement::LESS_THAN_ONE_YEAR}}</option>
                                        <option {{old('experience')=="one_three_year"?"selected":""}} value="one_three_year">{{\App\Models\Advertisement::ONE_THREE_YEAR}}</option>
                                        <option {{old('experience')=="three_five_year"?"selected":""}} value="three_five_year">{{\App\Models\Advertisement::THREE_FIVE_YEAR}}</option>
                                        <option {{old('experience')=="five_ten_year"?"selected":""}} value="five_ten_year">{{\App\Models\Advertisement::FIVE_TEN_YEAR}}</option>
                                        <option {{old('experience')=="five_ten_year"?"selected":""}} value="more_than_ten_year">{{\App\Models\Advertisement::MORE_THAN_TEN_YEAR}}</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }} " id="colFormLabelSm"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8" style="margin-left: -14px">
                                    <textarea id="w3review" name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" rows="4">{{old('description')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8" style="margin-left: -14px">
                                    <textarea id="w3review" name="duties" class="form-control {{ $errors->has('duties') ? 'is-invalid' : '' }}" rows="4">{{old('duties')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8" style="margin-left: -14px">
                                    <textarea id="w3review" name="requirements" class="form-control {{ $errors->has('requirements') ? 'is-invalid' : '' }}"
                            ...
                            <div class="form-group">
                                <div class="col-sm-8" style="margin-left: -14px;margin-top:10px">
                                    <input type="number" class="form-control {{ $errors->has('salary') ? 'is-invalid' : '' }}" id="colFormLabelSm"
                                           placeholder="salary">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8" style="margin-left: -14px">
                                    ...
                                    <input type="text" name="phone" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }} " id="colFormLabelSm"
                                           placeholder="phone">
                                    @if ($errors->has('phone'))
                                        <div class="error-block">
                                            {{$errors->first('phone') }}
